...
name: seance-figures
description: >
  Regles de dessin des 67 figures SVG d'exercice de CIRKALI : vocabulaire des
...
67 figures (66 exercices + `custom`), corps SVG bruts dans `src/data/figures.ts`,
...
node .claude/skills/seance-figures/figure-space.mjs         # les 67
```
...
bloc CSS, et la presence de la classe `fig-svg` sur les 330 fiches livrees.
