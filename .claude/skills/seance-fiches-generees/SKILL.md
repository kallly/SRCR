...
description: >
  Pipeline des 330 pages d'exercice statiques de Seance (une par exercice et
...
# Les 330 pages d'exercice generees
...
| Ce qui change sur les 330 pages | Où éditer |
|---|---|
...
les 330 pages en une fois — jamais besoin (et jamais correct) de modifier un
...
- **Contenu long** — `src/content/exercise-details/<locale>.ts`, sous la clé
  ...
  complètes** (66 exercices chacune), mais le contrat reste volontairement
