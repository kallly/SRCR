...
export const es: Translations = {
  ...
  legal: {
    title: 'Aviso legal',
    lead: 'Información legal sobre el sitio cirkali.fr, su editor y su alojamiento.',
    editorTitle: 'Editor del sitio',
    editorText:
      'CIRKALI (cirkali.fr) lo edita a título personal un particular no profesional. Conforme al artículo 6 III-2 de la ley francesa para la confianza en la economía digital, un editor no profesional puede no hacer públicos sus datos de contacto: los conserva el proveedor de alojamiento, que los comunica a requerimiento de la autoridad judicial. Cualquier solicitud, reclamaciones incluidas, pasa por la dirección de contacto del sitio: {email}.',
    directorTitle: 'Director de la publicación',
    directorText:
      'La dirección de la publicación corresponde al editor del sitio, localizable en {email}.',
    hostTitle: 'Alojamiento',
    hostText:
      'El sitio está alojado por Cloudflare, Inc., 101 Townsend Street, San Francisco, CA 94107, Estados Unidos (cloudflare.com).',
    ipTitle: 'Propiedad intelectual',
    ipText:
      'El código fuente, los textos de las fichas de ejercicio, las figuras y la identidad visual de CIRKALI están protegidos por derechos de autor, todos los derechos reservados. No se autoriza ninguna reproducción, adaptación, traducción ni redifusión sin acuerdo previo por escrito. Las sesiones que compones siguen siendo tuyas: solo salen de tu dispositivo si activas la copia en línea.',
    contentTitle: 'Contenido de entrenamiento',
    contentText:
      'Las fichas describen gestos y su anatomía a título informativo general. No constituyen un consejo médico, un diagnóstico ni un programa personalizado, y no sustituyen la opinión de un profesional sanitario ni de un educador deportivo. Cada cual practica bajo su propia responsabilidad; en caso de dolor, patología conocida, embarazo o vuelta tras una lesión, pide consejo antes de usarlas.',
    availabilityTitle: 'Disponibilidad y enlaces externos',
    availabilityText:
      'El sitio se ofrece tal cual, sin garantía de disponibilidad ni de ausencia de errores. Enlaza a servicios de terceros —Google para el inicio de sesión, la medición de audiencia y la publicidad, Cloudflare para el alojamiento— cuyos contenidos y prácticas escapan al control del editor.',
    lawTitle: 'Derecho aplicable',
    lawText:
      'El sitio se rige por el derecho francés. A falta de resolución amistosa, cualquier litigio es competencia de los tribunales franceses.',
  },
  contact: {
    title: 'Contacto',
    lead: 'CIRKALI lo desarrolla y mantiene una sola persona. No hay servicio de asistencia, pero los mensajes se leen y se responden.',
    writeTitle: 'Escribir',
    writeText: 'Una sola dirección, para todo: {email}.',
    usefulTitle: 'Lo que ayuda a responder antes',
    usefulText:
      'Un fallo se corrige mucho más rápido si el mensaje dice qué hacías, qué esperabas, qué ocurrió en su lugar y en qué navegador o teléfono. Una captura de pantalla vale a menudo un párrafo. Para un ejercicio que falta o un error en una ficha, basta el nombre del ejercicio y el idioma de la página.',
    dataTitle: 'Datos personales',
    dataText:
      'Para solicitar el acceso, la rectificación o la supresión de tus datos, escribe a la misma dirección indicando «RGPD» en el asunto. La página de Confidencialidad detalla qué se guarda y dónde.',
    delayTitle: 'Plazo de respuesta',
    delayText:
      'Cuenta con unos días. Las solicitudes sobre datos personales se tratan con prioridad, en un plazo máximo de un mes, como exige el RGPD.',
  },
  guides: {
    title: 'Guías',
    lead: 'Respuestas escritas a mano a las preguntas que vuelven siempre: cuántas series, cómo montar una sesión, qué material, cómo encadenar.',
    related: 'Fichas de ejercicio citadas',
    readOn: 'Las demás guías',
  },
  method: {
    title: 'Sobre el sitio y método',
    lead: 'Quién escribe CIRKALI, cómo se redacta el contenido y qué se prohíbe escribir el sitio.',
    whoTitle: 'Quién hace CIRKALI',
    whoText:
      'CIRKALI lo diseña, escribe y mantiene una sola persona, sin redacción externa ni contenido comprado. Las {count} fichas de ejercicio, las guías y las figuras se han producido para este sitio y no existen en ningún otro lugar. El proyecto nació de una necesidad simple: planificar una sesión y cronometrarla, sin cuenta que crear y sin que los datos salgan a ninguna parte.',
    ruleTitle: 'La regla de redacción',
    ruleText:
      'Una sola regla gobierna todo el contenido de entrenamiento del sitio: escribir únicamente lo verificable y lo estable. La anatomía —el nombre de los músculos y su función—, la biomecánica —acciones articulares, planos de movimiento, tipos de contracción— y los principios de entrenamiento establecidos. Nada más.',
    noFakeTitle: 'Lo que el sitio se prohíbe',
    noFakeText:
      'Nunca un estudio citado, nunca un porcentaje de activación muscular, nunca una cifra de falsa precisión. Esas tres cosas suenan científicas siendo casi siempre inventadas, y están por todas partes en el contenido de fitness en línea. Un texto que afirma que un ejercicio «recluta el 63 % del glúteo mayor» no dice nada verificable: toma prestada la apariencia de una prueba. Los rangos de repeticiones se presentan como usos documentados, no como leyes.',
    medicalTitle: 'Lo que esto no es',
    medicalText:
      'Las fichas y las guías son información general. No son un consejo médico, un diagnóstico ni un programa personalizado, y no sustituyen ni a un profesional sanitario ni a un educador deportivo. Las precauciones escritas en las fichas son prácticas —dónde colocar un codo, cuándo parar— nunca diagnósticos.',
    updatesTitle: 'Correcciones y actualizaciones',
    updatesText:
      'Un error en una ficha se corrige: comunícalo por la página de contacto indicando el ejercicio y el idioma. Las fichas se regeneran en cada publicación desde una fuente única, así que una corrección se propaga a los cinco idiomas de una vez.',
    freeTitle: 'Cómo se financia el sitio',
    freeText:
      'CIRKALI es gratuito y seguirá siéndolo. El sitio muestra anuncios solo en pantallas grandes: por debajo de 1200 píxeles de ancho no se descarga ningún código publicitario, lo que deja el uso en el teléfono enteramente libre de publicidad. Ningún contenido está patrocinado y ningún ejercicio se destaca a cambio de una remuneración.',
  },
  ...
  install: {
    ...
    chrome:
      'En Android, abre este sitio en Chrome, luego el menú ⋮ arriba a la derecha y «Instalar aplicación». CIRKALI se añade a tu pantalla de inicio con su propio icono, se abre a pantalla completa sin barra de direcciones y funciona sin conexión.',
    ios: 'En iPhone y iPad es en Safari: el botón Compartir y luego «Añadir a pantalla de inicio».',
    native:
      'Las versiones para Android y iOS están en preparación. Publicarlas en las tiendas de aplicaciones tiene un coste — cuenta de desarrollador, verificación de identidad, cuotas anuales — que el sitio aún no cubre.',
    support: 'Ayudar a financiar la publicación en Ko-fi',
  },

  support: {
    title: 'Apoyar CIRKALI',
    text:
      'CIRKALI es gratuito, se usa sin cuenta y no muestra publicidad en móvil. Si la aplicación te sirve, puedes invitar a un café: financia el alojamiento y las cuotas de las tiendas de aplicaciones.',
    link: 'Invitar a un café en Ko-fi',
  },
